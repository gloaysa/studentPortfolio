...
//|______________________________________________________|
  ...
  addTo: function(obj){
    ...
    //we search for properties inside the object passed.
    for (key in obj) {
    	var opProperty = obj[key];
      //is the property is found inside the schema.
      if (key in this.schema){
        //and matches with the an schema's property.
  ...
  //| passed as arg inside operations array and operate the|
  //| function inside with the number passed as args       |
  //|______________________________________________________|
